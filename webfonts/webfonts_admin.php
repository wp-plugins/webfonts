...
?>
<div class="wrap">
<div class="wfs_web_logo"><a style="text-decoration: none;" target="_blank" href="http://webfonts.fonts.com"><img src="<?php echo WP_PLUGIN_URL . '/webfonts/images/logo.gif'; ?>" /></a></div>
...
<tr>
     ...
     <td><img src="<?php echo WP_PLUGIN_URL . '/webfonts/images/'; echo ($project['is_active']==1)?'tick.gif':'cross.gif'; ?>" /></td>
   </tr>
<?php } 
}else{?>
<tr>
 ...
 <form method="post" action="admin.php?page=wfs_options&func=configure_act">
    <div id="poststuff">
    	<div class="meta-box-sortables ui-sortable" >
           ...
           <?php /****** Commented to disable editor option - By Keshant
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="widefat" style="margin-top:20px;" >
                        <tbody>
                        	<?php
							 ...
							 // load a json file.
							$apiurl = "json/Domains/?wfspstart=0&wfsplimit=".DOMAIN_LIMIT."&wfspid=".$result->project_key;
							$wfs_api = new Services_WFS($wfs_public_key,$wfs_private_key,$apiurl);
							$jsonUrl = $wfs_api->wfs_getInfo_post();
							//Creating JSON Instance
							//Creating array from json data
