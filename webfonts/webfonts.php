...
function wfs_admin_head() { 
	wp_enqueue_script('wfscookie',WP_PLUGIN_URL . '/webfonts/js/jquery_cookie.js','','1.0');
	wp_enqueue_script('ckeditorScript',WP_PLUGIN_URL . '/webfonts/ckeditor/ckeditor.js','','1.0');
	wp_enqueue_script('webfontsScript',WP_PLUGIN_URL . '/webfonts/js/webfonts.js','','1.0');
	...
	echo "<link rel='stylesheet' href='".WP_PLUGIN_URL ."/webfonts/css/webfonts.css' type='text/css' />\n";
...
register_deactivation_hook( __FILE__, 'wfs_deactivate' );//hook to call the function when it is deactivated
/*
